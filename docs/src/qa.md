...
When it comes to sample rates, the M2 RD allows for a mix of high speed (up to 40 kHz) and low speed (1 - 100 Hz) input channels. It's quite common for parameters like voltage and accelerations to be measured with a high-speed scheme, while slower responding parameters, such as temperatures and pressures measured at a lower rate. 
